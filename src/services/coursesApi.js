...
export function getCourse(id){
    ...
    return requestWithRefresh(`${id}/`);
}

/**
 * Funcion para crear un curso
 * @param { object } course: un objeto con los datos del curso a crear
 */
export function createCourse(course){
    // Hacer la peticion POST, enviando el curso en el cuerpo en formato JSON
    const options = { method : 'POST', body: JSON.stringify(course) };
...
export function updateCourse(id,updates){
    ...
    return requestWithRefresh(`${id}/`,options);
}
